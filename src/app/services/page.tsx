      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            <div className="md:flex">
              <div className="md:w-1/2 relative min-h-[320px] p-8 text-white overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-3xl font-bold">{tr("AC Repair", "إصلاح المكيف")}</h2>
                  </div>
                  <p className="text-blue-100 text-lg mb-6">
                    {tr(
                      "Complete air conditioning repair and maintenance services for residential and commercial properties.",
                      "خدمات إصلاح وصيانة المكيفات بشكل كامل للمنازل والمنشآت التجارية."
                    )}
                  </p>
                </div>
              </div>
              <div className="md:w-1/2 p-10">
                ...
                >
                  {tr("Get AC Repair Quote", "احصل على عرض لإصلاح المكيف")}
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="md:flex">
              <div className="md:w-1/2 p-10">
                <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                  ...
                  {tr("Refrigerator Repair", "إصلاح الثلاجة")}
                </h2>
                <p className="text-gray-600 text-lg mb-6">
                  {tr(
                    "Expert refrigerator and fridge repair services for all makes and models. From ice makers to cooling systems, we fix it all.",
                    "خدمات إصلاح الثلاجات والبرادات لجميع الأنواع والموديلات. من صانعات الثلج إلى أنظمة التبريد، نصلح كل شيء."
                  )}
                </p>
                <Link
                  href="/contact"
                ...
                >
                  {tr("Get Fridge Repair Quote", "احصل على عرض لإصلاح الثلاجة")}
                </Link>
              </div>
              <div className="md:w-1/2 relative min-h-[320px] p-8 text-white overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[var(--color-teal)]/75" aria-hidden />
                <div className="relative z-10">
                  <h2 className="text-2xl font-semibold mb-4 text-white">{tr("Common Issues We Fix:", "أعطال شائعة نقوم بإصلاحها:")}</h2>
                  <div className="space-y-3">
            ...
            <div className="md:flex">
              <div className="md:w-1/2 relative min-h-[380px] p-8 text-white overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-3xl font-bold">{tr("Washing Machine Repair", "إصلاح الغسالة")}</h2>
                  </div>
                  <p className="text-blue-100 text-lg mb-6">
                    {tr(
                      "Professional washing machine repair services for all brands and models. We diagnose and fix all types of washer issues.",
                      "خدمات إصلاح الغسالات لجميع الماركات والموديلات. نقوم بالتشخيص والإصلاح لجميع الأعطال."
                    )}
                  </p>
              ...
              <div className="md:w-1/2 p-10">
                ...
                <Link
                  ...
                  className="inline-block bg-[var(--color-teal)] text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-colors"
                >
                  {tr("Get Washer Repair Quote", "احصل على عرض لإصلاح الغسالة")}
                </Link>
              </div>
            </div>
          </div>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{tr("Additional Services", "خدمات إضافية")}</h2>
            <p className="text-lg text-gray-600">{tr("We also provide these complementary services", "نقدم أيضًا هذه الخدمات المساندة")}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">{tr("Professional installation of new appliances with proper setup and testing", "تركيب احترافي للأجهزة الجديدة مع ضبط الإعدادات والاختبار")}</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">{tr("Preventive maintenance plans to keep your appliances running smoothly", "خطط صيانة وقائية للحفاظ على أداء أجهزتك بأفضل شكل")}</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">{tr("24/7 emergency repair services for critical appliance failures", "خدمات إصلاح طارئة 24/7 للأعطال الحرجة")}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
                <div className="flex items-start gap-4 p-4 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{tr("Experienced technicians in all brands of AC and appliances", "فنيون ذوو خبرة في جميع ماركات المكيفات والأجهزة")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow">
                  <svg className="w-6 h-6 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{tr("All repairs backed by our comprehensive warranty", "جميع الإصلاحات مدعومة بضمان شامل")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow">
                  <svg className="w-6 h-6 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{tr("No hidden fees, upfront pricing guaranteed", "لا رسوم مخفية، تسعير واضح مسبقًا")}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <ScrollReveal animation="fade-up">
          <section className="rounded-lg p-12 text-center text-white" style={{ backgroundColor: 'var(--color-teal)' }}>
            <h2 className="text-3xl font-bold mb-6">{t("services.cta.readyTitle")}</h2>
          <p className="text-xl mb-8 opacity-90">
            {t("services.cta.readySubtitle")}
          </p>
